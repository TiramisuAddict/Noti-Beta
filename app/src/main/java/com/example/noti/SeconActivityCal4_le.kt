...
class SeconActivityCal4_le : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_secon_cal4_le)
        ...
        RealtimeCheck2(n1orale , n1_orale , n1ctr1 , n1orale , n1c1 , n1res)
        RealtimeCheck2(n1c1 , n1_orale , n1ctr1 , n1orale , n1c1 , n1res)
            ...
            if (!checkBoxSport.isChecked) { //Exempt Sport #--False--#
                val CalculationResult =
                    ((n1res.text.toString().toFloat() * 4)
                            ...
                            + (n11res.text.toString().toFloat() * 1)) / 21
                ...
                startActivity(
                    Intent(this@SeconActivityCal4_le, ResActivity::class.java)
                ...
                val CalculationResult =
                    ((n1res.text.toString().toFloat() * 4)
                            ...
                            + (n8res.text.toString().toFloat() * 4)
                            + (n9res.text.toString().toFloat() * 1)
                            + (n10res.text.toString().toFloat() * 1)) / 20
                val R_CalculationResult = BigDecimal(CalculationResult.toFloat().toDouble()).setScale(2, RoundingMode.HALF_EVEN)
                val FinalResult = R_CalculationResult.toString()
