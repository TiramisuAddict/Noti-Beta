...
class SeconActivityCal3_in : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_secon_cal3_in)
            ...
            if (!checkBoxSport.isChecked) { //Exempt Sport #--False--#
                val CalculationResult =
                    ((n1res.text.toString().toFloat() * 1)
                            ...
                            + (n10res.text.toString().toFloat() * 3)
                ...
                startActivity(
                    Intent(this@SeconActivityCal3_in, ResActivity::class.java)
