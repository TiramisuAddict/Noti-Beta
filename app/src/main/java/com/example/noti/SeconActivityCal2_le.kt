...
class SeconActivityCal2_le : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_secon_cal2_le)
        ...
        val n1synt2 = findViewById<TextInputLayout>(R.id.n1_synt2)
        ...
        val n1s2 = findViewById<TextInputEditText>(R.id.n1s2)

        val n1res = findViewById<TextView>(R.id.n1_res)

        RealtimeCheck5(n1orale , n1_orale , n1ctr1 , n1ctr2 , n1synt , n1synt2 , n1orale , n1c1 , n1c2 , n1s , n1s2 , n1res)
        RealtimeCheck5(n1c1 , n1_orale , n1ctr1 , n1ctr2 , n1synt , n1synt2 , n1orale , n1c1 , n1c2 , n1s , n1s2 , n1res)
        RealtimeCheck5(n1c2 , n1_orale , n1ctr1 , n1ctr2 , n1synt , n1synt2 , n1orale , n1c1 , n1c2 , n1s , n1s2 , n1res)
        RealtimeCheck5(n1s , n1_orale , n1ctr1 , n1ctr2 , n1synt , n1synt2 , n1orale , n1c1 , n1c2 , n1s , n1s2 , n1res)
        RealtimeCheck5(n1s2 , n1_orale , n1ctr1 , n1ctr2 , n1synt , n1synt2 , n1orale , n1c1 , n1c2 , n1s , n1s2 , n1res)
        ...
        RealtimeCheck2(n8c1 , n8ctr1 , n8synt , n8c1 , n8s , n8res)
        RealtimeCheck2(n8s , n8ctr1 , n8synt , n8c1 , n8s , n8res)
        ...
        RealtimeCheck2(n11c1 , n11ctr1 , n11synt , n11c1 , n11s , n11res)
        RealtimeCheck2(n11s , n11ctr1 , n11synt , n11c1 , n11s , n11res)
        ...
        checkBoxSport.setOnClickListener {
            ...
            if (checkBoxSport.isChecked){
                n11ctr1.isEnabled = false
                n11synt.isEnabled = false
                n11res.text = getString(R.string.exempt_)
            }else{ //in case the checkbox is not checked
                n11ctr1.isEnabled = true
                n11synt.isEnabled = true
                if (n11c1.text.toString() == "" && n11s.text.toString() == ""){
                    n11res.text = getString(R.string.ResetCounter) //setting the value to 00.00
                }else if (n11c1.text.toString() != "" && n11s.text.toString() != ""){
                    n11res.text = MoyenneDe2(n11c1.text.toString().toFloat() , n11s.text.toString().toFloat())
                }else{
                    n11res.text = getString(R.string.ResetCounter) //setting the value to 00.00
                }
            }
        ...
        btn.setOnClickListener {
            if (!checkBoxSport.isChecked) { //Exempt Sport #--False--#
                val CalculationResult =
                    ((n1res.text.toString().toFloat() * 4)
                            + (n2res.text.toString().toFloat() * 4)
                            + (n3res.text.toString().toFloat() * 3)
                            + (n4res.text.toString().toFloat() * 1.5)
                            + (n5res.text.toString().toFloat() * 1.5)
                            + (n6res.text.toString().toFloat() * 1)
                            + (n7res.text.toString().toFloat() * 1)
                            + (n8res.text.toString().toFloat() * 1)
                            + (n9res.text.toString().toFloat() * 1)
                            + (n10res.text.toString().toFloat() * 1.5)
                            + (n11res.text.toString().toFloat() * 1)) / 20.5
                ...
                startActivity(
                    Intent(this@SeconActivityCal2_le, ResActivity::class.java)
                ...
                val CalculationResult =
                    ((n1res.text.toString().toFloat() * 4)
                            ...
                            + (n8res.text.toString().toFloat() * 1)
                            + (n9res.text.toString().toFloat() * 1)
                            + (n10res.text.toString().toFloat() * 1.5)) / 19.5
                val R_CalculationResult = BigDecimal(CalculationResult.toFloat().toDouble()).setScale(2, RoundingMode.HALF_EVEN)
                val FinalResult = R_CalculationResult.toString()
