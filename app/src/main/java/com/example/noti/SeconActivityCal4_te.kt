...
class SeconActivityCal4_te  : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_secon_cal4_te)
        ...
        //For Cab l!culating stuff with stuff (2)
        ...
        RealtimeCheck1(n1s , n1synt , n1s , n1res)
        ...
        val n7ctr1e = findViewById<TextInputLayout>(R.id.n7_ctr1e)
        val n7ctr2e = findViewById<TextInputLayout>(R.id.n7_ctr2e)
        val n7synte = findViewById<TextInputLayout>(R.id.n7_synte)

        val n7c1e = findViewById<TextInputEditText>(R.id.n7c1e)
        val n7c2e = findViewById<TextInputEditText>(R.id.n7c2e)
        val n7se = findViewById<TextInputEditText>(R.id.n7se)

        val n7res = findViewById<TextView>(R.id.n7_res)

        RealtimeCheck6(n7c1 , n7ctr1 , n7ctr2 , n7synt , n7ctr1e , n7ctr2e , n7synte , n7c1 , n7c2 , n7s , n7c1e , n7c2e , n7se , n7res)
        RealtimeCheck6(n7c2 , n7ctr1 , n7ctr2 , n7synt , n7ctr1e , n7ctr2e , n7synte , n7c1 , n7c2 , n7s , n7c1e , n7c2e , n7se , n7res)
        RealtimeCheck6(n7s , n7ctr1 , n7ctr2 , n7synt , n7ctr1e , n7ctr2e , n7synte , n7c1 , n7c2 , n7s , n7c1e , n7c2e , n7se , n7res)

        RealtimeCheck6(n7c1e , n7ctr1 , n7ctr2 , n7synt , n7ctr1e , n7ctr2e , n7synte , n7c1 , n7c2 , n7s , n7c1e , n7c2e , n7se , n7res)
        RealtimeCheck6(n7c2e , n7ctr1 , n7ctr2 , n7synt , n7ctr1e , n7ctr2e , n7synte , n7c1 , n7c2 , n7s , n7c1e , n7c2e , n7se , n7res)
        RealtimeCheck6(n7se , n7ctr1 , n7ctr2 , n7synt , n7ctr1e , n7ctr2e , n7synte , n7c1 , n7c2 , n7s , n7c1e , n7c2e , n7se , n7res)
        ...
        RealtimeCheck2(n10c1 , n10ctr1 , n10synt , n10c1 , n10s , n10res)
        RealtimeCheck2(n10s , n10ctr1 , n10synt , n10c1 , n10s , n10res)
        ...
        checkBoxSport.setOnClickListener {
            ...
            if (checkBoxSport.isChecked){
                n10ctr1.isEnabled = false
                n10synt.isEnabled = false
                n10res.text = getString(R.string.exempt_)
            }else{ //in case the checkbox is not checked
                n10ctr1.isEnabled = true
                n10synt.isEnabled = true
                if (n10c1.text.toString() == "" && n10s.text.toString() == ""){
                    n10res.text = getString(R.string.ResetCounter) //setting the value to 00.00
                }else if (n10c1.text.toString() != "" && n10s.text.toString() != ""){
                    n10res.text = MoyenneDe2(n10c1.text.toString().toFloat() , n10s.text.toString().toFloat())
                }else{
                    n10res.text = getString(R.string.ResetCounter) //setting the value to 00.00
                }
            }
            ...
            if (!checkBoxSport.isChecked) { //Exempt Sport #--False--#
                val CalculationResult =
                    ((n1res.text.toString().toFloat() * 1)
                            + (n2res.text.toString().toFloat() * 1)
                            + (n3res.text.toString().toFloat() * 1)
                            + (n4res.text.toString().toFloat() * 1)
                            + (n5res.text.toString().toFloat() * 3)
                            + (n6res.text.toString().toFloat() * 4)
                            + (n7res.text.toString().toFloat() * 4)
                            + (n8res.text.toString().toFloat() * 1)
                            + (n9res.text.toString().toFloat() * 1)
                            + (n10res.text.toString().toFloat() * 1) ) / 18
                ...
                startActivity(
                    Intent(this@SeconActivityCal4_te, ResActivity::class.java)
                ...
                val CalculationResult =
                    ((n1res.text.toString().toFloat() * 1)
                            ...
                            + (n7res.text.toString().toFloat() * 4)
                            + (n8res.text.toString().toFloat() * 1)
                            + (n9res.text.toString().toFloat() * 1) ) / 17
                val R_CalculationResult = BigDecimal(CalculationResult.toFloat().toDouble()).setScale(2, RoundingMode.HALF_EVEN)
                val FinalResult = R_CalculationResult.toString()
