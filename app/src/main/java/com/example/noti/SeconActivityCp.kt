...
class SeconActivityCp  : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_secon_cp)
        ...
        btn.setOnClickListener {
            if (!checkBoxSport.isChecked) { //Exempt Sport #--False--#
                val CalculationResult =
                    ((n1res.text.toString().toFloat() * 3)
                            + (n2res.text.toString().toFloat() * 2.5)
                            + (n3res.text.toString().toFloat() * 1.5)
                            ...
                            + (n9res.text.toString().toFloat() * 2.5)
                ...
                startActivity(
                    Intent(this@SeconActivityCp, ResActivity::class.java)
                        .putExtra("Moy", FinalResult) )
            }

            else { //Exempt Sport #--True--#
                val CalculationResult =
                    ((n1res.text.toString().toFloat() * 3) + (n2res.text.toString()
                        .toFloat() * 2.5) + (n3res.text.toString()
                        .toFloat() * 1.5) + (n4res.text.toString()
                        .toFloat() * 1.5) + (n5res.text.toString()
                        .toFloat() * 1.5) + (n6res.text.toString()
                        .toFloat() * 1) + (n7res.text.toString()
                        .toFloat() * 1) + (n8res.text.toString()
                        .toFloat() * 3) + (n9res.text.toString()
                        .toFloat() * 2.5) + (n10res.text.toString()
                        .toFloat() * 1.5) + (n11res.text.toString()
                        .toFloat() * 1) + (n12res.text.toString()
                        .toFloat() * 1.5)) / 21.5
                val R_CalculationResult = BigDecimal(CalculationResult.toFloat().toDouble()).setScale(2, RoundingMode.HALF_EVEN)
                val FinalResult = R_CalculationResult.toString()
