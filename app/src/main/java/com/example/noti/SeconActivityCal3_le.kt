...
class SeconActivityCal3_le : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_secon_cal3_le)
            ...
            if (!checkBoxSport.isChecked) { //Exempt Sport #--False--#
                val CalculationResult =
                    ((n1res.text.toString().toFloat() * 4)
                            ...
                            + (n10res.text.toString().toFloat() * 1)
                            + (n11res.text.toString().toFloat() * 1)) / 19
                ...
                startActivity(
                    Intent(this@SeconActivityCal3_le, ResActivity::class.java)
