...
class PrepActivityCal9 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_prep_cal9)
        ...
        btn.setOnClickListener {
            ...
            if (!checkBoxThea.isChecked && !checkBoxSport.isChecked){ //Exempt --> Sport #--False--# || Theatre #--False--#
                ...
                startActivity(
                    Intent(this@PrepActivityCal9, ResActivity::class.java).putExtra("Moy" ,FinalResult)
                )
