...
class SeconActivityCal2_ec : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_secon_cal2_ec)
            ...
            if (!checkBoxSport.isChecked) { //Exempt Sport #--False--#
                val CalculationResult =
                    ((n1res.text.toString().toFloat() * 2)
                            ...
                            + (n11res.text.toString().toFloat() * 3)
                            + (n12res.text.toString().toFloat() * 1) ) / 22
                ...
                startActivity(
                    Intent(this@SeconActivityCal2_ec, ResActivity::class.java)
                ...
                val CalculationResult =
                    ((n1res.text.toString().toFloat() * 2)
                            ...
                            + (n9res.text.toString().toFloat() * 3)
                            + (n10res.text.toString().toFloat() * 1.5)
                            + (n11res.text.toString().toFloat() * 3) ) / 21
                val R_CalculationResult = BigDecimal(CalculationResult.toFloat().toDouble()).setScale(2, RoundingMode.HALF_EVEN)
                val FinalResult = R_CalculationResult.toString()
