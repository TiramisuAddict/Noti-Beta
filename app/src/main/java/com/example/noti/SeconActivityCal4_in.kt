...
class SeconActivityCal4_in  : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_secon_cal4_in)
        ...
        //For Cab l!culating stuff with stuff (1)
            ...
            if (!checkBoxSport.isChecked) { //Exempt Sport #--False--#
                val CalculationResult =
                    ((n1res.text.toString().toFloat() * 1)
                            ...
                            + (n6res.text.toString().toFloat() * 3)
                            + (n7res.text.toString().toFloat() * 3)
                ...
                startActivity(
                    Intent(this@SeconActivityCal4_in, ResActivity::class.java)
                ...
                val CalculationResult =
                    ((n1res.text.toString().toFloat() * 1)
                            ...
                            + (n7res.text.toString().toFloat() * 3)
                            + (n8res.text.toString().toFloat() * 1)
                            + (n9res.text.toString().toFloat() * 3) ) / 17
                val R_CalculationResult = BigDecimal(CalculationResult.toFloat().toDouble()).setScale(2, RoundingMode.HALF_EVEN)
                val FinalResult = R_CalculationResult.toString()
