...
class SeconActivityCal3_ec : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_secon_cal3_ec)
        ...
        //Philosophy (6)
        val n6synt = findViewById<TextInputLayout>(R.id.n6_ctr1)

        val n6s = findViewById<TextInputEditText>(R.id.n6c1)

        val n6res = findViewById<TextView>(R.id.n6_res)

        RealtimeCheck1(n6s , n6synt , n6s , n6res)
        ...
        btn.setOnClickListener {
            if (!checkBoxSport.isChecked) { //Exempt Sport #--False--#
                ...
                startActivity(
                    Intent(this@SeconActivityCal3_ec, ResActivity::class.java)
                ...
                val CalculationResult =
                    ((n1res.text.toString().toFloat() * 2)
                            ...
                            + (n9res.text.toString().toFloat() * 4)
                            + (n10res.text.toString().toFloat() * 1)
                            + (n11res.text.toString().toFloat() * 1) ) / 22.5
                val R_CalculationResult = BigDecimal(CalculationResult.toFloat().toDouble()).setScale(2, RoundingMode.HALF_EVEN)
                val FinalResult = R_CalculationResult.toString()
