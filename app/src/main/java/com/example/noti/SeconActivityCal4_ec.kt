...
class SeconActivityCal4_ec  : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_secon_cal4_ec)
        ...
        RealtimeCheck2(n6c1 , n6ctr1 , n6synt , n6c1 , n6s , n6res)
        RealtimeCheck2(n6s , n6ctr1 , n6synt , n6c1 , n6s , n6res)
        ...
        RealtimeCheck2(n7c1 , n7ctr1 , n7synt , n7c1 , n7s , n7res)
        RealtimeCheck2(n7s , n7ctr1 , n7synt , n7c1 , n7s , n7res)
        ...
        checkBoxSport.setOnClickListener {
            ...
            if (checkBoxSport.isChecked){
                n12ctr1.isEnabled = false
                n12synt.isEnabled = false
                n12res.text = getString(R.string.exempt_)
            }else{ //in case the checkbox is not checked
                n12ctr1.isEnabled = true
                n12synt.isEnabled = true
                if (n12c1.text.toString() == "" && n12s.text.toString() == ""){
                    n12res.text = getString(R.string.ResetCounter) //setting the value to 00.00
                }else if (n12c1.text.toString() != "" && n12s.text.toString() != ""){
                    n12res.text = MoyenneDe2(n12c1.text.toString().toFloat() , n12s.text.toString().toFloat())
                }else{
                    n12res.text = getString(R.string.ResetCounter) //setting the value to 00.00
                }
            }
        ...
        btn.setOnClickListener {
            if (!checkBoxSport.isChecked) { //Exempt Sport #--False--#
                ...
                startActivity(
                    Intent(this@SeconActivityCal4_ec, ResActivity::class.java)
                ...
                val CalculationResult =
                    ((n1res.text.toString().toFloat() * 1)
                            ...
                            + (n9res.text.toString().toFloat() * 4)
                            + (n10res.text.toString().toFloat() * 1)
                            + (n11res.text.toString().toFloat() * 1) ) / 19.5
                val R_CalculationResult = BigDecimal(CalculationResult.toFloat().toDouble()).setScale(2, RoundingMode.HALF_EVEN)
                val FinalResult = R_CalculationResult.toString()
