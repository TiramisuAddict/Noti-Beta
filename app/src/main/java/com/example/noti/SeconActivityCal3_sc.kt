...
class SeconActivityCal3_sc : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_secon_cal3_sc)
            ...
            if (!checkBoxSport.isChecked) { //Exempt Sport #--False--#
                val CalculationResult =
                    ((n1res.text.toString().toFloat() * 2)
                            ...
                            + (n8res.text.toString().toFloat() * 3)
                            + (n9res.text.toString().toFloat() * 4)
                            + (n10res.text.toString().toFloat() * 4)
                            + (n11res.text.toString().toFloat() * 1)
                            + (n12res.text.toString().toFloat() * 1)
                            + (n13res.text.toString().toFloat() * 1)) / 24
                ...
                startActivity(
                    Intent(this@SeconActivityCal3_sc, ResActivity::class.java)
                ...
                val CalculationResult =
                    ((n1res.text.toString().toFloat() * 2)
                            ...
                            + (n10res.text.toString().toFloat() * 4)
                            + (n11res.text.toString().toFloat() * 1)
                            + (n12res.text.toString().toFloat() * 1)) / 23
                val R_CalculationResult = BigDecimal(CalculationResult.toFloat().toDouble()).setScale(2, RoundingMode.HALF_EVEN)
                val FinalResult = R_CalculationResult.toString()
