...
class SeconActivityCal3_te  : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_secon_cal3_te)
        ...
        // MoyenneDe2Info : (2)(Info)
        fun MoyenneDe2Info (ctr : Float , synt : Float ) : String{
            val resi = BigDecimal( ( (ctr+synt )/2 ).toDouble() ).setScale(2, RoundingMode.HALF_EVEN)
            return resi.toString()
        }

        // MoyenneDe1 : (1)
        fun MoyenneDe1 (synt : Float ) : String{
            val resi = BigDecimal( (synt).toDouble() ).setScale(2, RoundingMode.HALF_EVEN)
            return resi.toString()
        }

        // MoyenneDe5 : (5) (Ar)
        fun MoyenneDe6 (tp : Float , ctr :Float , synt : Float , tpe :Float, ctre :Float , synte : Float ) : String{
            val resi = BigDecimal( ( (((tp+tpe)/2) + ((ctr+ctre)/2) + (((synt+synte)/2)*2)) /4).toDouble()).setScale(2, RoundingMode.HALF_EVEN)
            return resi.toString()
        }

        //For Calculating stuff with stuff (6)
        fun RealtimeCheck6 (targetX : TextInputEditText, nf1 : TextInputLayout, nf2 : TextInputLayout, nf3 : TextInputLayout, nf4 : TextInputLayout, nf5 : TextInputLayout , nf6 : TextInputLayout,
                            ng1 : TextInputEditText, ng2 : TextInputEditText, ng3 : TextInputEditText, ng4 : TextInputEditText, ng5 : TextInputEditText , ng6 : TextInputEditText, nxr : TextView){

            targetX.addTextChangedListener(object : TextWatcher {

                override fun afterTextChanged(s: Editable) {
                    if (ng1.text.toString() == "" || ng2.text.toString() == "" || ng3.text.toString() == "" || ng4.text.toString() == "" || ng5.text.toString() == "" || ng6.text.toString() == ""){
                ...
                override fun onTextChanged(s: CharSequence, start: Int, before: Int, count: Int) {
                    ...
                    if (ng1.text.toString() != "" && ng2.text.toString() != "" && ng3.text.toString() != "" && ng4.text.toString() != "" && ng5.text.toString() != "" && ng6.text.toString() != ""){
                        ...
                        nxr.text = MoyenneDe6( ng1.text.toString().toFloat() , ng2.text.toString().toFloat() , ng3.text.toString().toFloat() , ng4.text.toString().toFloat() , ng5.text.toString().toFloat() , ng6.text.toString().toFloat())
                        ...
                        if (ng6.text.toString().length > 6 || ng6.text.toString().toFloat() > 20){
                            nf6.error = "_"
                        }else if(ng6.text.toString().length <= 6 && ng6.text.toString().toFloat() <= 20){
                            nf6.error = null
                        }
        ...
        fun RealtimeCheck2 (targetX : TextInputEditText ,nf : TextInputLayout , nfx : TextInputLayout ,
                            ng :TextInputEditText , ngx :TextInputEditText , nxr : TextView ,infocheck : Boolean){
            ...
            targetX.addTextChangedListener(object : TextWatcher {
                ...
                override fun onTextChanged(s: CharSequence, start: Int, before: Int, count: Int) {
                    ...
                    if (ng.text.toString()  != "" && ngx.text.toString() != ""){
                        ...
                        //executing the calculating function(s)
                        if (infocheck){
                            nxr.text = MoyenneDe2Info(ng.text.toString().toFloat() , ngx.text.toString().toFloat())
                        }else{
        ...
        //For Calculating stuff with stuff (1)
        fun RealtimeCheck1 (targetX : TextInputEditText , nfx : TextInputLayout , ngx :TextInputEditText , nxr : TextView){

            targetX.addTextChangedListener(object : TextWatcher {

                override fun afterTextChanged(s: Editable) {
                    if (ngx.text.toString() == ""){
                        nxr.text = getString(R.string._00_00)
                    }
                }
                override fun beforeTextChanged(s: CharSequence, start: Int, count: Int, after: Int) {}
                ...
                override fun onTextChanged(s: CharSequence, start: Int, before: Int, count: Int) {
                    ...
                    if (ngx.text.toString() != ""){
                        ...
                        //executing the calculating function(s)
                        nxr.text = MoyenneDe1(ngx.text.toString().toFloat())
        ...
        val n6ctr1e = findViewById<TextInputLayout>(R.id.n6_ctr1e)
        val n6ctr2e = findViewById<TextInputLayout>(R.id.n6_ctr2e)
        val n6synte = findViewById<TextInputLayout>(R.id.n6_synte)

        val n6c1e = findViewById<TextInputEditText>(R.id.n6c1e)
        val n6c2e = findViewById<TextInputEditText>(R.id.n6c2e)
        val n6se = findViewById<TextInputEditText>(R.id.n6se)
        
        val n6res = findViewById<TextView>(R.id.n6_res)

        RealtimeCheck6(n6c1 , n6ctr1 , n6ctr2 , n6synt , n6ctr1e , n6ctr2e , n6synte , n6c1 , n6c2 , n6s , n6c1e , n6c2e , n6se , n6res)
        RealtimeCheck6(n6c2 , n6ctr1 , n6ctr2 , n6synt , n6ctr1e , n6ctr2e , n6synte , n6c1 , n6c2 , n6s , n6c1e , n6c2e , n6se , n6res)
        RealtimeCheck6(n6s , n6ctr1 , n6ctr2 , n6synt , n6ctr1e , n6ctr2e , n6synte , n6c1 , n6c2 , n6s , n6c1e , n6c2e , n6se , n6res)

        RealtimeCheck6(n6c1e , n6ctr1 , n6ctr2 , n6synt , n6ctr1e , n6ctr2e , n6synte , n6c1 , n6c2 , n6s , n6c1e , n6c2e , n6se , n6res)
        RealtimeCheck6(n6c2e , n6ctr1 , n6ctr2 , n6synt , n6ctr1e , n6ctr2e , n6synte , n6c1 , n6c2 , n6s , n6c1e , n6c2e , n6se , n6res)
        RealtimeCheck6(n6se , n6ctr1 , n6ctr2 , n6synt , n6ctr1e , n6ctr2e , n6synte , n6c1 , n6c2 , n6s , n6c1e , n6c2e , n6se , n6res)
        ...
        RealtimeCheck2(n8c1 , n8ctr1 , n8synt , n8c1 , n8s , n8res,false)
        RealtimeCheck2(n8s , n8ctr1 , n8synt , n8c1 , n8s , n8res,false)
        ...
        RealtimeCheck1(n11s , n11synt , n11s , n11res)
        ...
        RealtimeCheck2(n12c1 , n12ctr1 , n12synt , n12c1 , n12s , n12res,true)
        RealtimeCheck2(n12s , n12ctr1 , n12synt , n12c1 , n12s , n12res,true)
        ...
        RealtimeCheck2(n13c1 , n13ctr1 , n13synt , n13c1 , n13s , n13res,false)
        RealtimeCheck2(n13s , n13ctr1 , n13synt , n13c1 , n13s , n13res,false)
        ...
        btn.setOnClickListener {
            if (!checkBoxSport.isChecked) { //Exempt Sport #--False--#
                val CalculationResult =
                    ((n1res.text.toString().toFloat() * 1)
                            + (n2res.text.toString().toFloat() * 2)
                            + (n3res.text.toString().toFloat() * 2)
                            + (n4res.text.toString().toFloat() * 1)
                            + (n5res.text.toString().toFloat() * 1)
                            + (n6res.text.toString().toFloat() * 4)
                            + (n7res.text.toString().toFloat() * 1)
                            + (n8res.text.toString().toFloat() * 4)
                            + (n9res.text.toString().toFloat() * 3)
                            + (n11res.text.toString().toFloat() * 1)
                            + (n12res.text.toString().toFloat() * 1)
                            + (n13res.text.toString().toFloat() * 1)) / 22
                ...
                startActivity(
                    Intent(this@SeconActivityCal3_te, ResActivity::class.java)
                ...
                val CalculationResult =
                    ((n1res.text.toString().toFloat() * 1)
                            ...
                            + (n9res.text.toString().toFloat() * 3)
                            + (n11res.text.toString().toFloat() * 1)
                            + (n12res.text.toString().toFloat() * 1)) / 21
                val R_CalculationResult = BigDecimal(CalculationResult.toFloat().toDouble()).setScale(2, RoundingMode.HALF_EVEN)
                val FinalResult = R_CalculationResult.toString()
